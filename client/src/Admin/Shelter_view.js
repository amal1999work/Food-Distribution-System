...
function Shelter_view() {
  ...
  useEffect(() => {
    ...
    .then((result) => {
      ...
      console.log(result.licenseno,"ee")
    })
    .catch((error) => {
                ...
                <div class="card-body">
                  ...
                  <form>
                    ...
                    <div class="form-group">
                      ...
                      <a href={`http://localhost:3005/${licenseno}`} target="_blank" rel="noopener noreferrer" style={{color:'red'}}>
                            View License
                          </a>
