            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">New Registered Donors</h5>
                  <div className="table-responsive">
                    <table className="table">
                      ...
                      <tbody>
                        {filteredDonors.new.map((donor, index) => (
                          <tr key={index}>
                            ...
                            <td>{donor.contact}</td>
                            <td>
                              <button className="btn btn-success mx-2" onClick={() => handleApprove(donor._id)}>Approve</button>
                              <button className="btn btn-danger" onClick={() => handleReject(donor._id)}>Reject</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
