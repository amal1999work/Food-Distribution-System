            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title mt-5">Rejected Shelters</h5>
                  <div className="table-responsive">
                    <table className="table">
                      ...
                      <tbody>
                        {rejectedShelters.map((shelter, index) => (
                          <tr key={shelter._id}>
                            ...
                            <td><Link to='/shelterview' state={{ id: shelter._id }}>
                              ...
                              <button className="btn btn-success mr-2" onClick={() => handleApprove(shelter._id)}>Accept</button></td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
