            ...
            <div className="col-lg-12">
              <div className="card">
                <div className="card-body">
                  <h5 className="card-title">New Shelters</h5>
                      ...
                      <tbody>
                        {shelters.map((shelter, index) => (
                          <tr key={shelter._id}>
                            ...
                            <td>
                              <Link to='/shelterview' state={{ id: shelter._id }}>
                                <button type="button" className="btn btn-primary mr-2">
                                  View
                                </button>
                              </Link>
                              <button className="btn btn-success mr-2" onClick={() => handleApprove(shelter._id)}>Accept</button>
                              <button className="btn btn-danger mr-2" onClick={() => handleReject(shelter._id)}>Reject</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
